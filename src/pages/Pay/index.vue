<template>
  <div class="pay-main">
    <el-button class="primary" icon="el-icon-plus">测试</el-button>
...
export default {
  ...
  methods: {
    ...
    async open() {
      ...
      this.$alert(`<img src=${url}>`, "请用微信扫码进行支付", {
